...
const AuthLayout: React.FC<AuthLayoutProps> = (props) => {
  const { children } = props;
    return (
      <div className='flex justify-center items-center w-[495px] h-[565px] bg-[#E6E2F2] rounded-[50px] shadow-[0px_2px_4px_0px_rgba(0,0,0,0.25)] border-2 border-solid backdrop-blur-md py-16'>
